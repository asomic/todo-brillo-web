$(function () {
    ...
    $("#ar-1").click(function () {
        ...
        $(".aroma-info").removeClass(
            "algodon bambu lavanda floral bebe vainilla anti-tabaco"
        );
    });
    ...
    $("#ar-2").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina algodon bambu lavanda floral bebe vainilla anti-tabaco"
        );
    });
    ...
    $("#ar-3").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian bambu lavanda floral bebe vainilla anti-tabaco"
        );
    ...
    $("#ar-4").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian algodon lavanda floral bebe vainilla anti-tabaco"
        );
        // $('.aroma-info').removeClass('brisa-marina hawaiian algodon bambu lavanda floral bebe vainilla anti-tabaco');
    });
    ...
    $("#ar-5").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian algodon bambu floral bebe vainilla anti-tabaco"
        );
        // $('.aroma-info').removeClass('brisa-marina hawaiian algodon bambu lavanda floral bebe vainilla anti-tabaco');
    });
    ...
    $("#ar-6").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian algodon bambu lavanda bebe vainilla anti-tabaco"
        );
        // $('.aroma-info').removeClass('brisa-marina hawaiian algodon bambu lavanda floral bebe vainilla anti-tabaco');
    });
    ...
    $("#ar-7").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian algodon bambu lavanda floral vainilla anti-tabaco"
        );
    });
    ...
    $("#ar-8").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina hawaiian algodon bambu lavanda floral anti-tabaco"
        );
    });
    ...
    $("#ar-9").click(function () {
        ...
        $(".aroma-info").removeClass(
            "brisa-marina vainilla hawaiian algodon bambu lavanda floral"
        );
    });
    ...
    //     $(".electricos .header .img").removeClass(
    //         "e-lavanda e-manzana e-brisa"
    //     );
    // });
